...
class TestFirmwareManager:
    ...
    def test_no_firmware_available(self):
        ...
        info = manager.get_firmware_info()
        assert info is None
    ...
    def test_get_firmware_path(self):
        ...
        manager = FirmwareManager(self.tmpdir)
        path = manager.get_firmware_path()
    ...
    def test_get_firmware_path_returns_none_when_missing(self):
        manager = FirmwareManager(self.tmpdir)
        assert manager.get_firmware_path() is None
    ...
    def test_build_ota_info_when_update_available(self):
        ...
        manager = FirmwareManager(self.tmpdir)
        ota = manager.build_ota_info("1.0.0", "entry123")
    ...
    def test_no_ota_when_device_is_newer(self):
        ...
        manager = FirmwareManager(self.tmpdir)
        ota = manager.build_ota_info("1.1.0", "entry123")
        assert ota is None
