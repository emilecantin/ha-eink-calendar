#!/usr/bin/env python3
"""Standalone runner for visual regression tests."""
...
from custom_components.epcal.renderer.renderer import render_to_png  # noqa: E402
...
class TestVisualRegression(unittest.TestCase):
    ...
    def test_today_section_with_events(self):
        ...
        calendar_events = cast(list[CalendarEvent], [
            {
                "calendar_id": "calendar.personal",
                "calendar_icon": "mdi:calendar",
        ...
        png_data = render_to_png(calendar_events, [], None, self.now, {})  # type: ignore[arg-type]
    ...
    def test_waste_collection_icons(self):
        ...
        png_data = render_to_png( [], waste_events, None, self.now, options)  # type: ignore[arg-type]
    ...
    def test_weather_display(self):
        ...
        png_data = render_to_png( [], [], weather, self.now, {})  # type: ignore[arg-type]
    ...
    def test_empty_calendar(self):
        ...
        png_data = render_to_png( [], [], None, self.now, {})  # type: ignore[arg-type]
...
<html>
<head>
    <title>EPCAL Visual Regression Test Report</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>EPCAL Visual Regression Test Report</h1>
