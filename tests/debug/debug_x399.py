...
print("Checking x=399 vertical border (Today/Week divider):")
print("=" * 60)

# Find gaps in Python render
print("\nGaps in Python render at x=399:")
in_gap = False
gap_start = None
for y in range(16, 970):
    ts_black = get_rgb(ts_pixels[399, y]) == (0, 0, 0)
    py_black = get_rgb(py_pixels[399, y]) == (0, 0, 0)
